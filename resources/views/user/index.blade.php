...
@section('content')
    ...
    <div class="card rounded-16 overflow-hidden border-0 bg-secondary mt-0 mt-md-4">
        <div class="row g-0">
            <div class="col-lg-7">
                <img src="{{ URL::asset('images/menus/menu1.jpg')}}" class="w-100" alt="Menu">
            </div>
            <div class="col-lg-5">
                <div class="p-4 p-md-5 d-flex flex-column justify-content-center h-100 position-relative">
                    <strong>
                        <svg data-name="feather-icon/trending-up" xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                             viewBox="0 0 20 20">
                            ...
                            <path
                                ...
                                transform="translate(0 4.167)" fill="#ff642f" />
                        </svg>
                        <span class="ml-2 caption font-weight-medium">85% would make this again</span>
                    </strong>
                    <h4 class="my-3">Mighty Super Cheesecake</h4>
                    <p class="big pr-0 pr-md-5 pb-3 pb-sm-5 pb-lg-0">Look no further for a creamy and ultra smooth classic
                        cheesecake recipe! no one can deny its simple decadence.</p>
            ...
            <div class="col-md-4">
                <figure class="my-3 tstbite-card">
                    <a href="#0" class="tstbite-animation rounded-6">
                        <img src="{{ URL::asset('images/menus/menu2.jpg')}}" class="w-100" alt="Menu">
                    </a>
    ...
    <section class="tstbite-components my-4 my-md-5">
        ...
        <div class="row">
            <div class="col-md-4">
                <figure class="my-3 tstbite-card">
                    <a href="#0" class="tstbite-animation rounded-6">
                        <img src="{{ URL::asset('images/menus/menu6.jpg')}}" class="w-100" alt="Menu">
                    </a>
                    <figcaption class="mt-2">
                        <div class="w-100 float-left">
                            <div class="float-left">
                        ...
                        <a href="#0" class="f-size-20 text-black d-block mt-1 font-weight-semibold">Caramel Strawberry
                            Milkshake</a>
                    </figcaption>
                </figure>
            </div>
            ...
            <div class="col-lg-2 col-md-4 col-4">
                <figure class="my-3 text-center tstbite-card">
                    <a href="category.html" class="tstbite-animation stretched-link rounded-circle">
                        <img src="{{ URL::asset('images/menus/menu8.png')}}" class="rounded-circle" alt="Menu">
                    </a>
                    <figcaption class="mt-2">
                ...
                <div class="col-md-6">
                    <figure class="my-3 tstbite-card">
                        <a href="#0" class="tstbite-animation stretched-link rounded-top-6">
                            <img src="{{ URL::asset('images/menus/menu16.jpg')}}"  class="w-100" alt="Menu">
                        </a>
                        <figcaption class="tstbite-collection border-top-0 rounded-bottom-6">
                            <div class="text-black pt-3 pb-4 px-4 d-lg-flex align-items-end justify-content-between text-right">
                                <h5 class="mb-3 md-lg-0 pr-0 pr-lg-4 text-left"><a href="#0" class="stretched-link">Sushi Combos for
                                        your Next Party</a></h5>
                ...
                <div class="col-lg-3 col-md-4 col-6">
                    <figure class="my-3 my-md-4 tstbite-card">
                        <a href="recipe-sidebar.html" class="tstbite-animation stretched-link rounded-6">
                            <img src="{{ URL::asset('images/menus/menu20.jpg')}}"  class="w-100" alt="Menu">
                        </a>
                        <figcaption class="mt-2">
